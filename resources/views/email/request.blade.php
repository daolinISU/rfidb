        ...
        <td>
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                ...
                <tr>
                    ...
                    <td width="200" valign="top">{{ $first_name." ".$last_name }}</td>
                </tr>

                <tr>
                    <td width="200" valign="top">Organization</td>
                    <td width="200" valign="top">{{ $organization }}</td>
                </tr>

                <tr>
                    <td width="200" valign="top">Reason to apply</td>
                    <td width="200" valign="top">{{ $reason }}</td>
                </tr>
            </table>
